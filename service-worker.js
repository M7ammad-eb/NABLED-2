...
const CACHE_NAME = 'nabled-cache-v9';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/style.css',
...
    event.waitUntil(
        caches.open(CACHE_NAME).then((cache) => {  // Use CACHE_NAME here
...
                        return caches.open(CACHE_NAME).then((cache) => { // Use CACHE_NAME
